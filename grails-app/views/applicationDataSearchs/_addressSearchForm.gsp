<table>
  ...
  <label for="adId"><g:message code="addressInfo.adId.label"/></label>
  <g:textField name="adId" value="${addressInfoInstance?.adId}"/>
  </td> 
<td> 
  <label for="adFirstName"><g:message code="addressInfo.adFirstName.label"/></label>
   <g:textField name="adFirstName" value="${addressInfoInstance?.adFirstName}"/>
</td>

<td>
  
  <label for="adMiddleName"><g:message code="addressInfo.adMiddleName.label"/></label>
...
<td> 
  <label for="adNationalIdNumber"><g:message code="addressInfo.adNationalIdNumber.label"/></label>
   <g:textField name="adNationalIdNumber" value="${addressInfoInstance?.adNationalIdNumber}"/>
</td>

<td>
  
  <label for="adEMail"><g:message code="addressInfo.adEMail.label"/></label>
