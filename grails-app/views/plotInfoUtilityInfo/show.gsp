	...
	<body>
		...
		<div id="show-plotInfoUtilityInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list plotInfoUtilityInfo">
				...
				<li class="fieldcontain">
					<span id="utTypePic-label" class="property-label"><g:message code="plotInfoUtilityInfo.utTypePic.label" default="Ut Type Pic" /></span>
				...
				<li class="fieldcontain">
					<span id="utRemark-label" class="property-label"><g:message code="plotInfoUtilityInfo.utRemark.label" default="Ut Remark" /></span>
