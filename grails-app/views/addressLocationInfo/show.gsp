		...
		<div id="show-addressLocationInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list addressLocationInfo">
				...
				<li class="fieldcontain">
					<span id="alId-label" class="property-label"><g:message code="addressLocationInfo.alId.label" default="Al Id" /></span>
				...
				<li class="fieldcontain">
					<span id="alLocationPic-label" class="property-label"><g:message code="addressLocationInfo.alLocationPic.label" default="Al Location Pic" /></span>
