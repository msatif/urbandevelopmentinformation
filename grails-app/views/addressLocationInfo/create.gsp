...
<html>
	...
	<body>
		...
		<div id="create-addressLocationInfo" class="content scaffold-create" role="main">
			...
			<g:hasErrors bean="${addressLocationInfoInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${addressLocationInfoInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:addressLocationInfoInstance, action:'save']"  enctype="multipart/form-data">
				<fieldset class="form">
