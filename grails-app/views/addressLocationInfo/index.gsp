		...
		<div id="list-addressLocationInfo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="alId" title="${message(code: 'addressLocationInfo.alId.label', default: 'Al Id')}" />
					
						<g:sortableColumn property="alReferenceId" title="${message(code: 'addressLocationInfo.alReferenceId.label', default: 'Al Reference Id')}" />
					
						<g:sortableColumn property="alType" title="${message(code: 'addressLocationInfo.alType.label', default: 'Al Type')}" />
					
						<g:sortableColumn property="alThanaCode" title="${message(code: 'addressLocationInfo.alThanaCode.label', default: 'Al Thana Code')}" />
					
						<g:sortableColumn property="alDistictCode" title="${message(code: 'addressLocationInfo.alDistictCode.label', default: 'Al Distict Code')}" />
					
						<g:sortableColumn property="alDivisionName" title="${message(code: 'addressLocationInfo.alDivisionName.label', default: 'Al Division Name')}" />
