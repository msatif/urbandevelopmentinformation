	...
	<body>
		...
		<div id="show-plotInfoBillingInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list plotInfoBillingInfo">
				...
				<li class="fieldcontain">
					<span id="biPrintCopy-label" class="property-label"><g:message code="plotInfoBillingInfo.biPrintCopy.label" default="Bi Print Copy" /></span>
				...
				<li class="fieldcontain">
					<span id="biRemark-label" class="property-label"><g:message code="plotInfoBillingInfo.biRemark.label" default="Bi Remark" /></span>
