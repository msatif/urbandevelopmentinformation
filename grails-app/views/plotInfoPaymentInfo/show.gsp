	...
	<body>
		...
		<div id="show-plotInfoPaymentInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list plotInfoPaymentInfo">
				...
				<li class="fieldcontain">
					<span id="paCopy-label" class="property-label"><g:message code="plotInfoPaymentInfo.paCopy.label" default="Pa Copy" /></span>
				...
				<li class="fieldcontain">
					<span id="paRemark-label" class="property-label"><g:message code="plotInfoPaymentInfo.paRemark.label" default="Pa Remark" /></span>
