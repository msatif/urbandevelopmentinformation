	...
	<body>
		...
		<div id="show-buildingInfoAuthorizationInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list buildingInfoAuthorizationInfo">
				...
				<li class="fieldcontain">
					<span id="auApplicationCopy-label" class="property-label"><g:message code="buildingInfoAuthorizationInfo.auApplicationCopy.label" default="Au Application Copy" /></span>
				...
				<li class="fieldcontain">
					<span id="auApprovedCopy-label" class="property-label"><g:message code="buildingInfoAuthorizationInfo.auApprovedCopy.label" default="Au Approved Copy" /></span>
				...
				<li class="fieldcontain">
					<span id="auRemark-label" class="property-label"><g:message code="buildingInfoAuthorizationInfo.auRemark.label" default="Au Remark" /></span>
