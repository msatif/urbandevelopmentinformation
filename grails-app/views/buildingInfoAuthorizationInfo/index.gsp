		...
		<div id="list-buildingInfoAuthorizationInfo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="auId" title="${message(code: 'buildingInfoAuthorizationInfo.auId.label', default: 'Au Id')}" />
					
						<g:sortableColumn property="auAddressId" title="${message(code: 'buildingInfoAuthorizationInfo.auAddressId.label', default: 'Au Address Id')}" />
					
						<g:sortableColumn property="auAppliedDate" title="${message(code: 'buildingInfoAuthorizationInfo.auAppliedDate.label', default: 'Au Applied Date')}" />
					
						<g:sortableColumn property="auApprovalDate" title="${message(code: 'buildingInfoAuthorizationInfo.auApprovalDate.label', default: 'Au Approval Date')}" />
					
						<g:sortableColumn property="auPublishDate" title="${message(code: 'buildingInfoAuthorizationInfo.auPublishDate.label', default: 'Au Publish Date')}" />
					
						<g:sortableColumn property="auCode" title="${message(code: 'buildingInfoAuthorizationInfo.auCode.label', default: 'Au Code')}" />
