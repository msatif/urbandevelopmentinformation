	...
	<body>
		...
		<div id="show-unitInfoUtilityInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list unitInfoUtilityInfo">
				...
				<li class="fieldcontain">
					<span id="utTypePic-label" class="property-label"><g:message code="unitInfoUtilityInfo.utTypePic.label" default="Ut Type Pic" /></span>
				...
				<li class="fieldcontain">
					<span id="utRemark-label" class="property-label"><g:message code="unitInfoUtilityInfo.utRemark.label" default="Ut Remark" /></span>
				...
				<li class="fieldcontain">
					<span id="unitInfo-label" class="property-label"><g:message code="unitInfoUtilityInfo.unitInfo.label" default="Unit Info" /></span>
				...
				<li class="fieldcontain">
					<span id="utType-label" class="property-label"><g:message code="unitInfoUtilityInfo.utType.label" default="Ut Type" /></span>
