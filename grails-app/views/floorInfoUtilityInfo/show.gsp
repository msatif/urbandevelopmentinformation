	...
	<body>
		...
		<div id="show-floorInfoUtilityInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list floorInfoUtilityInfo">
				...
				<li class="fieldcontain">
					<span id="utTypePic-label" class="property-label"><g:message code="floorInfoUtilityInfo.utTypePic.label" default="Ut Type Pic" /></span>
				...
				<li class="fieldcontain">
					<span id="utRemark-label" class="property-label"><g:message code="floorInfoUtilityInfo.utRemark.label" default="Ut Remark" /></span>
				...
				<li class="fieldcontain">
					<span id="utType-label" class="property-label"><g:message code="floorInfoUtilityInfo.utType.label" default="Ut Type" /></span>
