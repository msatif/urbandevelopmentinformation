	...
	<body>
		...
		<div id="show-unitInfoAuthorizationInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list unitInfoAuthorizationInfo">
				...
				<li class="fieldcontain">
					<span id="auApplicationCopy-label" class="property-label"><g:message code="unitInfoAuthorizationInfo.auApplicationCopy.label" default="Au Application Copy" /></span>
				...
				<li class="fieldcontain">
					<span id="auApprovedCopy-label" class="property-label"><g:message code="unitInfoAuthorizationInfo.auApprovedCopy.label" default="Au Approved Copy" /></span>
				...
				<li class="fieldcontain">
					<span id="auRemark-label" class="property-label"><g:message code="unitInfoAuthorizationInfo.auRemark.label" default="Au Remark" /></span>
