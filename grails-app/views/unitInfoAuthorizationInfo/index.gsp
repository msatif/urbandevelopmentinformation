		...
		<div id="list-unitInfoAuthorizationInfo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="auId" title="${message(code: 'unitInfoAuthorizationInfo.auId.label', default: 'Au Id')}" />
					
						<g:sortableColumn property="auAddressId" title="${message(code: 'unitInfoAuthorizationInfo.auAddressId.label', default: 'Au Address Id')}" />
					
						<g:sortableColumn property="auAppliedDate" title="${message(code: 'unitInfoAuthorizationInfo.auAppliedDate.label', default: 'Au Applied Date')}" />
					
						<g:sortableColumn property="auApprovalDate" title="${message(code: 'unitInfoAuthorizationInfo.auApprovalDate.label', default: 'Au Approval Date')}" />
					
						<g:sortableColumn property="auPublishDate" title="${message(code: 'unitInfoAuthorizationInfo.auPublishDate.label', default: 'Au Publish Date')}" />
					
						<g:sortableColumn property="auCode" title="${message(code: 'unitInfoAuthorizationInfo.auCode.label', default: 'Au Code')}" />
