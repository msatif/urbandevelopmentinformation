	...
	<body>
		...
		<div id="show-floorInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list floorInfo">
				...
				<li class="fieldcontain">
					<span id="flLayoutPicture-label" class="property-label"><g:message code="floorInfo.flLayoutPicture.label" default="Fl Layout Picture" /></span>
				...
				<li class="fieldcontain">
					<span id="flRemark-label" class="property-label"><g:message code="floorInfo.flRemark.label" default="Fl Remark" /></span>
