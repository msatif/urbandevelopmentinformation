		...
		<div id="list-plotInfo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="plAddressId" title="${message(code: 'plAddressId.label',)}" />
					
						<g:sortableColumn property="plCode" title="${message(code: 'plCode.label',)}" />
					
						<g:sortableColumn property="plName" title="${message(code: 'plName.label',)}" />
					
						<g:sortableColumn property="plType" title="${message(code: 'plType.label', )}" />
					
						<g:sortableColumn property="plNumber" title="${message(code: 'plNumber.label',)}" />
