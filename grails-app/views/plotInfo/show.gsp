		...
		<div id="show-plotInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list plotInfo">
				...
				<li class="fieldcontain">
					<span id="plId-label" class="property-label"><g:message code="plotInfo.plId.label" default="Pl Id" /></span>
				...
				<li class="fieldcontain">
					<span id="plAddressId-label" class="property-label"><g:message code="plotInfo.plAddressId.label" default="Pl Address Id" /></span>
				...
				<li class="fieldcontain">
					<span id="plCode-label" class="property-label"><g:message code="plotInfo.plCode.label" default="Pl Code" /></span>
				...
				<li class="fieldcontain">
					<span id="plName-label" class="property-label"><g:message code="plotInfo.plName.label" default="Pl Name" /></span>
				...
				<li class="fieldcontain">
					<span id="plType-label" class="property-label"><g:message code="plotInfo.plType.label" default="Pl Type" /></span>
				...
				<li class="fieldcontain">
					<span id="plNumber-label" class="property-label"><g:message code="plotInfo.plNumber.label" default="Pl Number" /></span>
				...
				<li class="fieldcontain">
					<span id="plMonzaNumber-label" class="property-label"><g:message code="plotInfo.plMonzaNumber.label" default="Pl Monza Number" /></span>
				...
				<li class="fieldcontain">
					<span id="plCSNumber-label" class="property-label"><g:message code="plotInfo.plCSNumber.label" default="Pl CSN umber" /></span>
				...
				<li class="fieldcontain">
					<span id="plMSNumber-label" class="property-label"><g:message code="plotInfo.plMSNumber.label" default="Pl MSN umber" /></span>
				...
				<li class="fieldcontain">
					<span id="plTotalArea-label" class="property-label"><g:message code="plotInfo.plTotalArea.label" default="Pl Total Area" /></span>
				...
				<li class="fieldcontain">
					<span id="plTotalBuildingCoverArea-label" class="property-label"><g:message code="plotInfo.plTotalBuildingCoverArea.label" default="Pl Total Building Cover Area" /></span>
				...
				<li class="fieldcontain">
					<span id="plNumberOfBuilding-label" class="property-label"><g:message code="plotInfo.plNumberOfBuilding.label" default="Pl Number Of Building" /></span>
				...
				<li class="fieldcontain">
					<span id="plHeightFromMSL-label" class="property-label"><g:message code="plotInfo.plHeightFromMSL.label" default="Pl Height From MSL" /></span>
				...
				<li class="fieldcontain">
					<span id="plCenterLongitude-label" class="property-label"><g:message code="plotInfo.plCenterLongitude.label" default="Pl Center Longitude" /></span>
				...
				<li class="fieldcontain">
					<span id="plCenterLatitude-label" class="property-label"><g:message code="plotInfo.plCenterLatitude.label" default="Pl Center Latitude" /></span>
				...
				<li class="fieldcontain">
					<span id="plLayoutPicture-label" class="property-label"><g:message code="plotInfo.plLayoutPicture.label" default="Pl Layout Picture" /></span>
				...
				<li class="fieldcontain">
					<span id="utilityLocationMap-label" class="property-label"><g:message code="plotInfo.utilityLocationMap.label" default="Utility Location Map" /></span>
				...
				<li class="fieldcontain">
					<span id="plRemark-label" class="property-label"><g:message code="plotInfo.plRemark.label" default="Pl Remark" /></span>
				...
				<li class="fieldcontain">
					<span id="ownership-label" class="property-label"><g:message code="plotInfo.ownership.label" default="Ownership" /></span>
				...
				<li class="fieldcontain">
					<span id="authorizationInfo-label" class="property-label"><g:message code="plotInfo.authorizationInfo.label" default="Authorization Info" /></span>
