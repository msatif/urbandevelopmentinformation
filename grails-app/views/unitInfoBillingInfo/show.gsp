	...
	<body>
		...
		<div id="show-unitInfoBillingInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list unitInfoBillingInfo">
				...
				<li class="fieldcontain">
					<span id="biPrintCopy-label" class="property-label"><g:message code="unitInfoBillingInfo.biPrintCopy.label" default="Bi Print Copy" /></span>
				...
				<li class="fieldcontain">
					<span id="biRemark-label" class="property-label"><g:message code="unitInfoBillingInfo.biRemark.label" default="Bi Remark" /></span>
