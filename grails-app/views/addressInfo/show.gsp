		...
		<div id="show-addressInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list addressInfo">
				...
				<li class="fieldcontain">
					<span id="adId-label" class="property-label"><g:message code="addressInfo.adId.label" default="Ad Id" /></span>
				...
				<g:if test="${addressInfoInstance?.adBirthCertificateNumber}">
				<li class="fieldcontain">
					<span id="adBirthCertificateNumber-label" class="property-label"><g:message code="addressInfo.adBirthCertificateNumber.label" default="Ad Birth Certificate Number" /></span>
					
						<span class="property-value" aria-labelledby="adBirthCertificateNumber-label"><g:fieldValue bean="${addressInfoInstance}" field="adBirthCertificateNumber"/></span>
				...
				<li class="fieldcontain">
					<span id="adBirthCertificateNumberPic-label" class="property-label"><g:message code="addressInfo.adBirthCertificateNumberPic.label" default="Ad Birth Certificate Number Pic" /></span>
				...
				<li class="fieldcontain">
					<span id="adNationalIdNumberPic-label" class="property-label"><g:message code="addressInfo.adNationalIdNumberPic.label" default="Ad National Id Number Pic" /></span>
				...
				<li class="fieldcontain">
					<span id="adPassportNumberPic-label" class="property-label"><g:message code="addressInfo.adPassportNumberPic.label" default="Ad Passport Number Pic" /></span>
