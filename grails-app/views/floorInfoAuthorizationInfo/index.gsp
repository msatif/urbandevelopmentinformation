		...
		<div id="list-floorInfoAuthorizationInfo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="auId" title="${message(code: 'floorInfoAuthorizationInfo.auId.label', default: 'Au Id')}" />
					
						<g:sortableColumn property="auAddressId" title="${message(code: 'floorInfoAuthorizationInfo.auAddressId.label', default: 'Au Address Id')}" />
					
						<g:sortableColumn property="auAppliedDate" title="${message(code: 'floorInfoAuthorizationInfo.auAppliedDate.label', default: 'Au Applied Date')}" />
					
						<g:sortableColumn property="auApprovalDate" title="${message(code: 'floorInfoAuthorizationInfo.auApprovalDate.label', default: 'Au Approval Date')}" />
					
						<g:sortableColumn property="auPublishDate" title="${message(code: 'floorInfoAuthorizationInfo.auPublishDate.label', default: 'Au Publish Date')}" />
					
						<g:sortableColumn property="auCode" title="${message(code: 'floorInfoAuthorizationInfo.auCode.label', default: 'Au Code')}" />
