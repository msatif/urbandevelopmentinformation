	...
	<body>
		...
		<div id="show-floorInfoAuthorizationInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list floorInfoAuthorizationInfo">
				...
				<li class="fieldcontain">
					<span id="auApplicationCopy-label" class="property-label"><g:message code="floorInfoAuthorizationInfo.auApplicationCopy.label" default="Au Application Copy" /></span>
				...
				<li class="fieldcontain">
					<span id="auApprovedCopy-label" class="property-label"><g:message code="floorInfoAuthorizationInfo.auApprovedCopy.label" default="Au Approved Copy" /></span>
				...
				<li class="fieldcontain">
					<span id="auRemark-label" class="property-label"><g:message code="floorInfoAuthorizationInfo.auRemark.label" default="Au Remark" /></span>
