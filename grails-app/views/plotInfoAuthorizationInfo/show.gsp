	...
	<body>
		...
		<div id="show-plotInfoAuthorizationInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list plotInfoAuthorizationInfo">
				...
				<li class="fieldcontain">
					<span id="auAddressId-label" class="property-label"><g:message code="plotInfoAuthorizationInfo.auAddressId.label" default="Au Address Id" /></span>
				...
				<li class="fieldcontain">
					<span id="auType-label" class="property-label"><g:message code="plotInfoAuthorizationInfo.auType.label" default="Au Type" /></span>
				...
				<li class="fieldcontain">
					<span id="auNumber-label" class="property-label"><g:message code="plotInfoAuthorizationInfo.auNumber.label" default="Au Number" /></span>
				...
				<li class="fieldcontain">
					<span id="auApplicationCopy-label" class="property-label"><g:message code="plotInfoAuthorizationInfo.auApplicationCopy.label" default="Au Application Copy" /></span>
				...
				<li class="fieldcontain">
					<span id="auApprovedCopy-label" class="property-label"><g:message code="plotInfoAuthorizationInfo.auApprovedCopy.label" default="Au Approved Copy" /></span>
				...
				<li class="fieldcontain">
					<span id="auRemark-label" class="property-label"><g:message code="plotInfoAuthorizationInfo.auRemark.label" default="Au Remark" /></span>
				...
				<li class="fieldcontain">
					<span id="auPlId-label" class="property-label"><g:message code="plotInfoAuthorizationInfo.auPlId.label" default="Au Pl Id" /></span>
